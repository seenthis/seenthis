...
function seenthis_declarer_tables_principales($tables_principales){
	...
	$me = array(
			...
			"id_dist"	=> "bigint(21) NOT NULL",
			"id_mot"	=> "bigint(21) NOT NULL",
			"texte"	=> "longtext NOT NULL",
			"statut" => "varchar(5) DEFAULT 'oui' NOT NULL",
			"ip" => "varchar(40) DEFAULT 'oui' NOT NULL"
			);
	...
	$tables_principales['spip_me'] =
		array('field' => &$me, 'key' => &$me_key);
...
function seenthis_declarer_tables_auxiliaires($tables_auxiliaires){
	...
	$tables_auxiliaires['spip_me_follow'] =
		array('field' => &$me_follow, 'key' => &$me_follow_key);
